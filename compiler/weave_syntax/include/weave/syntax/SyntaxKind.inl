...
WEAVE_SYNTAX_DECLARATION(FormalParameterDeclaration,            "[declaration::formal-parameter]")
WEAVE_SYNTAX_DECLARATION(SelfParameterDeclaration,              "[declaration::self-parameter]")
WEAVE_SYNTAX_DECLARATION(VariadicParameterDeclaration,          "[declaration::variadic-parameter]")
